...
import com.crm.qa.util.JiraServiceProviderClass;
...
public class TestJiraListener implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		if (isTicketReady) {
			...
			JiraServiceProviderClass jiraSp = new JiraServiceProviderClass("https://crmpro123.atlassian.net/",
					"shashankkajla.sk@gmail.com", "ZGfN5XUi42kUZdAeWMJf088D", "CRMPRO1");
